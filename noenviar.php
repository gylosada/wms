...
//$dominio_permitido = "tecnologisticaconsultores.com";
$dominio_permitido = "gmail.com";


$_REQUEST['recipient'] = "grilosada@gmail.com"
...
$subject = isset($_REQUEST['subject'])? $_REQUEST['subject'] : 'Consulta Online';
...
{
        if(strpos($_REQUEST['nombre'], '<')!==false) die('Argumento nombre no seguro. &Eacute;ste no puede contener caracteres &lt; o &gt;.');
        if(strpos($_REQUEST['nombre'], '>')!==false) die('Argumento nombre no seguro. &Eacute;ste no puede contener caracteres &lt; o &gt;.');
        if(strpos($_REQUEST['nombre'], "\n")!==false) die('Argumento nombre no seguro. &Eacute;ste debe ser una sola l&iacute;nea.');
        if(strpos($_REQUEST['nombre'], "\r")!==false) die('Argumento nombre no seguro. &Eacute;ste debe ser una sola l&iacute;nea.');
}
