...
{
        if(strpos($_REQUEST['name'], '<')!==false) die('Argumento name no seguro. &Eacute;ste no puede contener caracteres &lt; o &gt;.');
        if(strpos($_REQUEST['name'], '>')!==false) die('Argumento name no seguro. &Eacute;ste no puede contener caracteres &lt; o &gt;.');
        if(strpos($_REQUEST['name'], "\n")!==false) die('Argumento name no seguro. &Eacute;ste debe ser una sola l&iacute;nea.');
        if(strpos($_REQUEST['name'], "\r")!==false) die('Argumento name no seguro. &Eacute;ste debe ser una sola l&iacute;nea.');
}
